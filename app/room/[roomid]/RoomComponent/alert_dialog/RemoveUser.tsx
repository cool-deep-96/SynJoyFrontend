    ...
    return (
        ...
        <AlertDialogContent className="rounded-lg bg-[#3B3B3B] p-5">
          <AlertDialogHeader >
            ...
            Are your sure to remove <span className="text-red-600 font-semibold ">{member.userName}</span> from this room ??
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogAction onClick={() => removeMember(member.id, member.userName)} className="bg-green-600">Continue</AlertDialogAction>
