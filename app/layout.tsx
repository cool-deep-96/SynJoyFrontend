...
export const metadata: Metadata = {
  ...
  keywords: [
    'Sync Player', 'Watch Party', 'Watch together', 'Online Party', 'Sync Vibes', 
    'Youtube Video Sync', 'Create Room ', 'Online Theater', 
    'Online Theater At Home', 'Long Distance Party', 'Parth Together'
